...
<div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary"> Hello <?php echo $username; ?> Add New project</h6>
                                ...
                                <div class="card-body">
                                    <form form action="../handler.php?action=add-project" method="post">
                                        ...
                                        <button type="submit" name="addProject" class="btn btn-primary my-1">Add Project</button>
                                        </div>
                                        </div>
                                    </form>
                                </div>
